...
const atasanNavItems = [
  { href: '/performance-dashboard', label: 'Dashboard Kinerja', icon: AreaChart },
  { href: '/manage-cs', label: 'Manajemen Akun CS', icon: Users },
];

export function AtasanNavbar() {
